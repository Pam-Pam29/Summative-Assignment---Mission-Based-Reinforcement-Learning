...
def plot_results(results, all_callbacks):
 ...
 # Training curves for best 3 runs
 ax = axes[1, 1]
 ...
 plt.show()
 print("\n Saved: results/dqn_experiments.png")

 # ── Plot 2: DQN Loss / Q-value objective curve ────────────
 ...
 ax2.set_title("DQN Best Run — Cumulative Reward Curve")
