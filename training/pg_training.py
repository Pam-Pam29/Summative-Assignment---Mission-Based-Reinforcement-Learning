...
# A2C with vf_coef=0 approximates vanilla REINFORCE
# ============================================================
...
def plot_ppo_results(results, callbacks):
    ...
    ax2.set_title("PPO Best Run - Reward Curve")
...
def plot_reinforce_results(results, callbacks):
    ...
    ax2.set_title("REINFORCE Best Run - Reward Curve")
    ax2.set_xlabel("Episode")
    ax2.set_ylabel("Episode Reward")
    ax2.grid(alpha=0.3)
    plt.tight_layout()
...
def save_tables(ppo_results, rf_results):
    ...
    print("Saved: results/ppo_results.csv")
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("DQN results not found. Run dqn_training.py first.")
